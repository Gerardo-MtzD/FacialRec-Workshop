...
def add_input_distortions(flip_left_right, random_crop, random_scale,
  ...
  """
    ...
    resize_scale_value = tf.compat.v1.random_uniform(tensor_shape.TensorShape([]),
                                                     minval=1.0,
                                                     maxval=resize_scale)
    ...
    brightness_value = tf.compat.v1.random_uniform(tensor_shape.TensorShape([]),
...
def is_tmp_empty(tmp_path: Path) -> None:
    if tmp_path.is_dir():
...
if __name__ == '__main__':
    ...
    # CHECKING THAT tmp folder is empty
    is_tmp_empty(Path('C:/tmp'))
